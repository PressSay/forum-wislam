...
<template>
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-base-content font-extralight">
            ...
            <div v-if="sessions.length > 0" class="mt-5 space-y-6">
                <div v-for="(session, i) in sessions" :key="i" class="flex items-center">
                    ...
                    <div class="ms-3">
                        <div class="text-sm text-base-content font-extralight">
                            {{ session.agent.platform ? session.agent.platform : 'Unknown' }} - {{ session.agent.browser ? session.agent.browser : 'Unknown' }}
                        </div>

                        <div>
                            <div class="text-xs text-base-content font-thin">
                                {{ session.ip_address }},
            ...
            <div class="flex items-center mt-5">
                <button class="btn btn-secondary btn-outline" @click="confirmLogout">
